...
class PatchAvailabilityInfoConsumer(AvailabilityInfoConsumer):
    ...
    def _generate_request_message(self, obj_id):
        return Message().availability_info_request(Message.PATCH, obj_id)

    def _generate_abort_message(self, obj_id):
        return Message().availability_info_abort(Message.PATCH, obj_id)

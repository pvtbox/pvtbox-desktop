...
class PatchDataConsumer(DataConsumer):
    ...
    def _generate_data_request_message(self, obj_id, offset, length):
        return Message().data_request(Message.PATCH, obj_id, offset, length)

    def _generate_data_abort_message(self, obj_id, offset):
        return Message().data_abort(Message.PATCH, obj_id, offset)
